...
class FakePopularVideosRepository implements PopularVideosRepository {
  @override
  Future<PopularVideosResponse> getPopularVideos(
      {int page = 1, int perPage = 50}) async {
    return PopularVideosResponse.fromJson(_fakePopularVideoResponse);
  }

  @override
  String get path => throw UnimplementedError();

  final _fakePopularVideoResponse = <String, dynamic>{
    "page": 1,
    "per_page": 1,
    "total_results": 4089,
    ...
    "videos": [
      {
        ...
        "height": 1080,
        "url":
            "https://www.pexels.com/video/water-crashing-over-the-rocks-1093662/",
        "image":
            "https://images.pexels.com/videos/1093662/free-video-1093662.jpg?fit=crop&w=1200&h=630&auto=compress&cs=tinysrgb",
        "duration": 8,
        "user": {
          "id": 417939,
          "name": "Peter Fowler",
